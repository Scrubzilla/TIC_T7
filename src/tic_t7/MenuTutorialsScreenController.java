 ...
 * @author Nicklas
 */
public class MenuTutorialsScreenController implements Initializable {
//-------------------------------FXML VARIABLES-------------------------------\\    
    @FXML
...
//-----------------------------NON-FXML VARIABLES-----------------------------\\    
    private final String currentSceneIs = "MenuTutorialsScreen";
    ...
    private void buttonClick(ActionEvent event){
        ...
        switch(text){
            case "Basics":
                ...
                MethodHandler.getInstance().sceneSwitch(event, "FXMLGuidesBasics.fxml");
                break;
            case "Specifics":
                System.out.println("specifics");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLGuidesSpecifics.fxml");
                break;
            case "Backwards":
