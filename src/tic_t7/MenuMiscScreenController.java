 ...
 * @author Nicklas
 */
public class MenuMiscScreenController implements Initializable {
//------------------------------FXML VARIABLES--------------------------------\\    
    @FXML
...
//-----------------------------NON-FXML VARIABLES-----------------------------\\    
    private String currentSceneIs = "MenuMiscScreen";
    ...
    private void buttonClick(ActionEvent event){
        ...
        switch(text){
            case "ChangeLog":
                ...
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMiscChangeLog.fxml");
                break;
            case "Contact":
                System.out.println("Contact");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMiscContact.fxml");
                break;
            case "Notes":
            ...
            case "Sites":
                ...
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMiscSites.fxml");
                break;
            case "Backwards":
