 ...
 * @author Nicklas
 */
public class MenuMainScreenController implements Initializable {
//-------------------------------FXML VARIABLES-------------------------------\\    
    @FXML
...
//-----------------------------NON-FXML VARIABLES-----------------------------\\    
    private final String currentSceneIs = "MenuMainScreen";
    private final int menuTier = 0;

//------------------------------ON START-UP-----------------------------------\\
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        DataStorage.getInstance().setCurrentMenuTierPage(menuTier, currentSceneIs); //Sets the current page into the navigationbar page-saver
    ...
    private void buttonClick(ActionEvent event){
        ...
        switch(text){
            case "Guides":
                ...
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMenuGuidesScreen.fxml");
                break;
            case "Misc":
                System.out.println("misc");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMenuMiscScreen.fxml");
                break;
            case "Settings":
                System.out.println("settings");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMenuSettingsScreen.fxml");
                break;
            case "Tools":
                System.out.println("Tools");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLMenuToolsScreen.fxml");
                break;
            case "Backwards":
