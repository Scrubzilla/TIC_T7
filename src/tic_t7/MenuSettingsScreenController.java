 ...
 * @author Nicklas
 */
public class MenuSettingsScreenController implements Initializable {
//------------------------------FXML VARIABLES--------------------------------\\
    @FXML
...
//-----------------------------NON_FXML VARIABLES-----------------------------\\    
    private final String currentSceneIs = "MenuSettingsScreen";
    ...
    private void buttonClick(ActionEvent event){
        ...
        switch(text){
            case "Playstation":
                ...
                MethodHandler.getInstance().sceneSwitch(event, "FXMLSettingsPlaystation.fxml");
                break;
            case "Xbox":
                System.out.println("Xbox");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLSettingsXbox.fxml");
                break;
            case "Pc":
                System.out.println("PC");
                MethodHandler.getInstance().sceneSwitch(event, "FXMLSettingsPc.fxml");
                break;
            case "Backwards":
